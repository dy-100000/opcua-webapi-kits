...
@Schema(name = "CloseSessionResponse", description = "[Link to specification](https://reference.opcfoundation.org/v105/Core/docs/Part4/5.7.4/#5.7.4.2).")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", comments = "Generator version: 7.12.0")
public class CloseSessionResponse {

  private @Nullable ResponseHeader responseHeader;

  public CloseSessionResponse responseHeader(ResponseHeader responseHeader) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.responseHeader, closeSessionResponse.responseHeader);
  }
