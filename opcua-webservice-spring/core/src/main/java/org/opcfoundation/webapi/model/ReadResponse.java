...
@Schema(name = "ReadResponse", description = "[Link to specification](https://reference.opcfoundation.org/v105/Core/docs/Part4/5.11.2/#5.11.2.2).")
...
public class ReadResponse {
  ...
  @Valid
  private List<@Valid DataValue> results = new ArrayList<>();

  @Valid
  private List<@Valid DiagnosticInfo> diagnosticInfos = new ArrayList<>();

  public ReadResponse responseHeader(ResponseHeader responseHeader) {
  ...
  public ReadResponse results(List<@Valid DataValue> results) {
    this.results = results;
    return this;
  }

  public ReadResponse addResultsItem(DataValue resultsItem) {
  ...
  public List<@Valid DataValue> getResults() {
    return results;
  }

  public void setResults(List<@Valid DataValue> results) {
    this.results = results;
  }

  public ReadResponse diagnosticInfos(List<@Valid DiagnosticInfo> diagnosticInfos) {
    this.diagnosticInfos = diagnosticInfos;
    return this;
  }

  public ReadResponse addDiagnosticInfosItem(DiagnosticInfo diagnosticInfosItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.responseHeader, readResponse.responseHeader) &&
        Objects.equals(this.results, readResponse.results) &&
        Objects.equals(this.diagnosticInfos, readResponse.diagnosticInfos);
  }
