...
@Schema(name = "SetPublishingModeResponse", description = "[Link to specification](https://reference.opcfoundation.org/v105/Core/docs/Part4/5.14.4/#5.14.4.2).")
...
public class SetPublishingModeResponse {
  ...
  public SetPublishingModeResponse responseHeader(ResponseHeader responseHeader) {
  ...
  public SetPublishingModeResponse results(List<@Valid StatusCode> results) {
    this.results = results;
    return this;
  }

  public SetPublishingModeResponse addResultsItem(StatusCode resultsItem) {
  ...
  public SetPublishingModeResponse diagnosticInfos(List<@Valid DiagnosticInfo> diagnosticInfos) {
    this.diagnosticInfos = diagnosticInfos;
    return this;
  }

  public SetPublishingModeResponse addDiagnosticInfosItem(DiagnosticInfo diagnosticInfosItem) {
  ...
  public boolean equals(Object o) {
    ...
    SetPublishingModeResponse setPublishingModeResponse = (SetPublishingModeResponse) o;
    return Objects.equals(this.responseHeader, setPublishingModeResponse.responseHeader) &&
        Objects.equals(this.results, setPublishingModeResponse.results) &&
        Objects.equals(this.diagnosticInfos, setPublishingModeResponse.diagnosticInfos);
  }
