...
import org.opcfoundation.webserver.digitaltwin.callback.SubmodelCallback;
...
public class SubmodelType extends SubmodelTypeBase implements SubmodelCallback {
    public SubmodelType(
            String typeId,
