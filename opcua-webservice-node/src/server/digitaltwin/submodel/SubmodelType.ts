...
import type { EventElementType } from "../element/EventElementType";
import type { ReferenceElementType } from "../element/ReferenceElementType";
    ...
    private processReadVariableValueResponse(
        ...
        for (const item of subElementNames) {
            ...
            readVariableValueResponse.results.set(
                ...
                new UaDataValue((subElementNode as UaVariable).value, makeUaStatusCode(StatusCodes.Good)),
            );
        }
