import { UaLocalizedText, UaNodeId, UaNodeIdType } from "opcua-webapi-ts";
...
export class DigitalTwinSpace extends NodeManagerReactiveObject {
    ...
    addRepository(
        ...
        const objectNodeId = new UaNodeId(objectIdentifier.toByteString(), this.nsIndex(),UaNodeIdType.BYTESTRING);
